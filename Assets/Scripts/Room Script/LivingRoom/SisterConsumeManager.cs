...
public class SisterConsumeManager : MonoBehaviour
{
    ...
    private void Start()
    {
        characterStat = GameObject.Find("Sister").GetComponent<CharacterStat>();
        krms = FindObjectOfType<KitchenResourceManagerScript>();
    }
    private void OnEnable() 
    {
        SisterConsumableUI.OnUseConsumable += UseConsumable;
    }
